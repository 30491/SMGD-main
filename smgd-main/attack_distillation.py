...
parser.add_argument('--step_size', default=2, type=float, help='perturb step size') # pgd 2; bim -1
...
def main():
    ...
    snet1 = models.__dict__[args.arch](pretrained=True)
    ...
    # tmodel = torch.nn.DataParallel(tmodel,list(range(3))).cuda()
    # tmodel.cuda()
    tmodel = smodel1
    tmodel.eval()
