### admix方法可以适用于densenet和resnet网络结构，因为vt是对图片输入进行处理的，并不特定于某个网络结构
...
parser.add_argument('--output_dir', default='./output/densenet201/BIM/admix_t_', help='the path of the saved dataset')
