...
parser.add_argument('--output_dir', default='./output/resnet152/PGD/t0_', help='the path of the saved dataset')
...
parser.add_argument('--tem', default=40.0, type=float)# 集成的学生网络的温度
parser.add_argument('--snet_dir1', default='./result/resnet152/40/1gpu_checkpoint.pth.tar', help='the path of snet1')
parser.add_argument('--snet_dir2', default='./result/resnet152/20/1gpu_checkpoint.pth.tar', help='the path of snet2')
parser.add_argument('--snet_dir3', default='./result/resnet152/22/1gpu_checkpoint.pth.tar', help='the path of snet3')
parser.add_argument('--snet_dir4', default='./result/resnet152/24/1gpu_checkpoint.pth.tar', help='the path of snet4')
parser.add_argument('--snet_dir5', default='./result/resnet152/26/1gpu_checkpoint.pth.tar', help='the path of snet5')
parser.add_argument('--snet_dir6', default='./result/resnet152/28/1gpu_checkpoint.pth.tar', help='the path of snet6')
parser.add_argument('--snet_dir7', default='./result/resnet152/30/1gpu_checkpoint.pth.tar', help='the path of snet7')
parser.add_argument('--snet_dir8', default='./result/resnet152/32/1gpu_checkpoint.pth.tar', help='the path of snet8')
####################
...
output_dir = args.output_dir + str(tem)
# print(output_dir)
...
#         self.models = models
#         if weights is None:
#             self.weights = [0.2, 0.8]  # 设置二者的默认权重
#         else:
...
#         output = 0
#         for i in range(len(self.models)):
#             output += self.weights[i] * F.softmax(self.models[i](x), dim=1)
#         return torch.log(output)
...
def main():
    ...
    if args.ensemble == True:
        ...
        # smodel2 = torch.nn.DataParallel(smodel2, device_ids=[0,1])
        ...
        # smodel3 = torch.nn.DataParallel(smodel3, device_ids=[0,1])
        ...
        # smodel4 = torch.nn.DataParallel(smodel4, device_ids=[0,1])
        ...
        # smodel5 = torch.nn.DataParallel(smodel5, device_ids=[0,1])
        ...
        # smodel6 = torch.nn.DataParallel(smodel6, device_ids=[0,1])
        ...
        # smodel7 = torch.nn.DataParallel(smodel7, device_ids=[0,1])
        ...
        # smodel8 = torch.nn.DataParallel(smodel8, device_ids=[0,1])
