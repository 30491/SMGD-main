### 无res152和den201的权重文件，目前无法和我们的方法结合
...
parser.add_argument('--output_dir', default='./output/resnet50/BIM/RFA_t_', help='the path of the saved dataset')
...
# model_path = './torch_nets_weight/densenet_l2_eps0.ckpt'
...
# # print("model_dict:",model_dict.items())
...
#     print(k)
# new1_dict = {k:v for k,v in new_dict.items() if k in sd }
# sd.update(new1_dict)
# # print(sd)
#
